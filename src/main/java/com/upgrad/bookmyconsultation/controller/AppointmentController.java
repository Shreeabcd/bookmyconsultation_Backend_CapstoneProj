...
//	public void MapController(ModelMapper modelMapper) {
//		this.modelMapper = modelMapper;
//		this.modelMapper.typeMap(Appointment.class, AppointmentDTO.class).addMapping(Appointment::getAppointmentId, AppointmentDTO::setAppointmentId);
//	}
