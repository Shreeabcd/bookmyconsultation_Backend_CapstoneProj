...
public class AppointmentService {
	...
	//declare exceptions 'SlotUnavailableException' and 'InvalidInputException'
		...
		public String 	appointment (Appointment appointment) throws SlotUnavailableException, InvalidInputException {
			...
			Appointment checkAppointment = appointmentRepository.findByDoctorIdAndTimeSlotAndAppointmentDate(appointment.getDoctorId(), appointment.getTimeSlot(), appointment.getAppointmentDate());
